({
    ...
    initialize: function(options)
    {
        ...
        this.context.on("button:deploy_template_user_btn:click", this.saveDashboard, this);
        this.context.on("button:deploy_template_team_btn:click", this._deployData, this);
        this.context.on("button:deploy_template_role_btn:click", this._deployData, this);
    },

    _deployData: function(evt) {
        console.log(evt);
